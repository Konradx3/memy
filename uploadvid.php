    ...
    <body>
        ...
        <div class="main_content">
            <section class="content">
                ...
                <div class="upload">
                    <form enctype="multipart/form-data" action="dodawanievid.php" method="post" >
                        <span>Wpisz tytuł posta:</span><br />
                        <input type="text" name="opis" maxlength="30" size="25"/><br /><br />
                        <span>Wklej link z YouTube:</span><br />
                        <input type="text"name="link" maxlength="100" size="25"/><br /><br />
